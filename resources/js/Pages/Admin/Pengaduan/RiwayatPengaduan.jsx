        ...
        <>
            ...
            <Table {...getTableProps()}>
                ...
                <TableBody {...getTableBodyProps()}>
                    ...
                    <TableRow>
                        <TableCell sx={{ Typography: 2 }} colSpan={8}>
                            <TablePagination
                                gotoPage={gotoPage}
                                rows={rows}
                ...
                Cell: ({ row }) => {
                    return (
                        <Tooltip title="Details">
                            <Link href={`/admin/pengaduan/daftar-pengaduan/details/${row.original.id}`}>
                                <IconButton
